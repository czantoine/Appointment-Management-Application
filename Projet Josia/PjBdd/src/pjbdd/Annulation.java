...
public class Annulation extends javax.swing.JFrame implements ActionListener {
    ...
    public ArrayList<Consultations> listeCons() {
        ...
        try {
            ...
            ResultSet resultSet = state.executeQuery("SELECT * FROM consultation");
            Consultations cons;
        ...
        conn = MySQLConnect.connectDB();
            ...
            try {
                ...
                try {
                    ...
                    PreparedStatement pst2 = conn.prepareStatement("DELETE FROM consultation WHERE id_consultation="+idC);
                    pst2.executeUpdate();//REPRENDRE ICI EFFECER CONSULTE ET CONSULTATION MAIS PAS PATIENT
                    ...
                    JOptionPane.showMessageDialog(null, "Error, something happened.");
                }
