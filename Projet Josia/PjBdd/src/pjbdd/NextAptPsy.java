...
public class NextAptPsy extends javax.swing.JFrame implements ActionListener {
    ...
    public ArrayList<Consultations> listeCons() {
        ...
        try {
            conn = MySQLConnect.connectDB();
                ...
                ResultSet resultSet = state.executeQuery("SELECT * FROM consultations WHERE etat_consultation=1 ORDER BY date, heure ");
                Consultations cons;
    ...
    private void initComponents() {
        ...
        setTitle("Past appointments - Completed ");
        setResizable(false);
        ...
        jLabel1.setText("Your past appointements :");
