...
public class AddRdv extends javax.swing.JFrame {
    ...
    private void jrdvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jrdvActionPerformed
        ...
        try{
            ...
            String query = "INSERT INTO 'consultation'('id_consultation', 'Date','heure', 'Prix', 'type_de_paiement', 'nb_personnes', 'id_patient') VALUES (?,?,?,?,?,?,?) ";
            con = DriverManager.getConnection("jdbc:mysql://localhost:3308/Projet?serverTimezone=UTC", "josia_root", "josia_root");
